...
if($nxt==2 and  $row4['country_manager']=='-' ){
...
users=[
        ...
        ["Manager","<?php if(!$row_date['signature2'] ){echo "---/--/--";}else echo $row_date['signature2'] ?>"],
        ["Country Manager","<?php if(!$row_date['signature3'] ){echo "---/--/--";}else echo $row_date['signature3'] ?>"],
        ["HR Manager","<?php if(!$row_date['signature4'] ){echo "---/--/--";}else echo $row_date['signature4'] ?>"],
        ["Plant Manager","<?php if(!$row_date['signature5'] ){echo "---/--/--";}else echo $row_date['signature5'] ?>"],
        ["HR Director NA","<?php if(!$row_date['signature6'] ){echo "---/--/--";}else echo $row_date['signature6'] ?>"],
        ["Operations Director NA","<?php if(!$row_date['signature7'] ){echo "---/--/--";}else echo $row_date['signature7'] ?>"]
    ];
