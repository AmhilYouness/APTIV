...
$res3=mysqli_query($con,"select * from job_request_details ");
$count3=mysqli_num_rows($res3);

$res4=mysqli_query($con,"select * from plant ");
...
<div class='ct' id=u2>
    <h1>Dashboard</h1><br>
    <h1 style="text-align: center;">Welcome <?php echo $_SESSION['NAME']." ( ".$_SESSION['ROLE']." )"; ?></h1>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Plants</h5>
                      <span class="h2 font-weight-bold mb-0"><?php echo $count4 ?></span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Job requests</h5>
