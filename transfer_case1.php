...
if($nxt==7 and  $row4['country_manager']=='-' ){
...
if($nxt==8 and  $row5['receiver_country_manager']=='-' ){
    $sqlnxt="update job_request  set approved_Level=approved_Level+1 where id='$id' ";
    mysqli_query($con,$sqlnxt);
    $res=mysqli_query($con,"select * from job_request where id='$id' ");
    $row=mysqli_fetch_assoc($res);
...
users=[
        ["Dev Team of Giver Plant","<?php if(!$row_date['signature1'] ){echo "---/--/--";}else echo $row_date['signature1'] ?>"],
        ...
        ["Giver HR Manager","<?php if(!$row_date['signature4'] ){echo "---/--/--";}else echo $row_date['signature4'] ?>"],
        ["Receiver HR Manager","<?php if(!$row_date['signature5'] ){echo "---/--/--";}else echo $row_date['signature5'] ?>"],
        ["Giver Plant Manager","<?php if(!$row_date['signature6'] ){echo "---/--/--";}else echo $row_date['signature6'] ?>"],
        ["Recv. Plant Manager","<?php if(!$row_date['signature7'] ){echo "---/--/--";}else echo $row_date['signature7'] ?>"],
        ["Giver Country Manager","<?php if(!$row_date['signature8'] ){echo "---/--/--";}else echo $row_date['signature8'] ?>"],
        ["Recv. Country Manager","<?php if(!$row_date['signature9'] ){echo "---/--/--";}else echo $row_date['signature9'] ?>"],
        ["HR Director NA","<?php if(!$row_date['signature10'] ){echo "---/--/--";}else echo $row_date['signature10'] ?>"],
        ["Operations Director NA","<?php if(!$row_date['signature11'] ){echo "---/--/--";}else echo $row_date['signature11'] ?>"]
    ];
